...
class TestKauppa(unittest.TestCase):
    ...
    def test_uusi_ostos_nollaa_edellisen(self):
        pankki_mock = Mock()
        ...
        kauppa.aloita_asiointi()
        kauppa.lisaa_koriin(1)
        kauppa.tilimaksu("pekko", "12345")

        # varmistetaan, että metodia tilisiirto on kutsuttu
        pankki_mock.tilisiirto.assert_called_with( "pekko", ANY, "12345",  "33333-44455", 5)

    def test_uusi_viite_uudelle_ostokselle(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
